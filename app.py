...
def download():
    ...
    ydl_opts = {
        "outtmpl": output_path,
        "format": "bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best/bestvideo/mp4",
    ...
    try:
        ...
        # Faylni yuborish va keyin o'chirish
        ...
        if "File is larger than max-filesize" in err:
            return jsonify({
                "error": "too_large",
                "message": "Video 50MB dan katta, yuklab bo'lmadi"
            }), 413
